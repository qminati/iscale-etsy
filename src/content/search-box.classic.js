...
function keystrokeDelayMs(rand = Math.random, min = 40, max = 140) {
...
async function typeAndSubmitSearch(doc, term, deps = {}) {
...
function activateSearchSubmit(doc, controls = null) {
...
function planNextPage(doc, currentPage) {
...
function clickPlannedNext(doc, plan) {
  ...
  api.findSearchBox = findSearchBox;
  api.findSearchSubmit = findSearchSubmit;
  api.keystrokeDelayMs = keystrokeDelayMs;
  api.formatSearchPathLog = formatSearchPathLog;
  api.isEtsySearchForTerm = isEtsySearchForTerm;
  api.typeAndSubmitSearch = typeAndSubmitSearch;
  api.activateSearchSubmit = activateSearchSubmit;
  api.planNextPage = planNextPage;
  api.clickPlannedNext = clickPlannedNext;
  api.SEARCH_BOX_SELECTORS = SEARCH_BOX_SELECTORS;
